...
export class FormComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.form = this.fb.group({
            ...
            ip: [log.ip, [Validators.required, Validators.minLength(9), Validators.maxLength(15), Validators.pattern("\\b((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)(\\.|$)){4}\\b")]],
            request: [log.request, [Validators.required, Validators.minLength(5), Validators.maxLength(23)]],
            status: [log.status, [Validators.required, Validators.minLength(3), Validators.pattern("[0-9]*")]],
            userAgent: [log.userAgent, [Validators.required, Validators.minLength(15), Validators.maxLength(255)]]
        });
    }
